...
<div class="container py-5">
        <div class="row py-3">
            <div class="col-lg-5 mb-4">
                <img src="<?= base_url('uploads/logoRQ.png')?>" class="d-block w-50 rounded" alt="...">
            </div>
...
<section class="page-section bg-light <?= isset($menu_status['agenda']) && !$menu_status['agenda'] ? 'd-none' : '' ?>" id="agenda">
    <div class="container pb-5">
        <div class="row pb-3 align-items-top">
            <!-- gallery sekolah  -->
        <section class="page-section bg-light <?= isset($menu_status['gallery']) && !$menu_status['gallery'] ? 'd-none' : '' ?>" id="galeri">
    <div class="container">
        <div class="row">
    ...
    <div class="py-2">
        <div class="container text-center bg-success text-white py-5">
            <div class="fs-2 mb-3">Segera Daftar!</div>
                <p>Menerima Peserta Didik Baru Rumah Qur'an Insan Toda</p>
            <div class="pt-2">
